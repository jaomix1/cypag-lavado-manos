...
export class GrupoService {
  ...
  getAll(filter: PaginatorModel): Observable<Combo[]> {
    return this._baseHttp.post<Combo[]>(`${this.constants.webApi}${CrudUrlConstant.getAllGrupo}`, filter)
  }


  getOne(id: number): Observable<Combo[]> {
    return this._baseHttp.get<Combo[]>(`${this.constants.webApi}${CrudUrlConstant.getOneGrupo}${id}`)
  }


  create(body: any) {
    return this._baseHttp.post(`${this.constants.webApi}${CrudUrlConstant.createGrupo}`, body)
  }

  update(id: number, body: any) {
    return this._baseHttp.put(`${this.constants.webApi}${CrudUrlConstant.updateGrupo}${id}`, body)
  }

  delete(id: number) {
    return this._baseHttp.delete(`${this.constants.webApi}${CrudUrlConstant.deleteGrupo}${id}`)
  }
